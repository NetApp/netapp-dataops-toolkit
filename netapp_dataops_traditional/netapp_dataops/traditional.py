...
def clone_volume(new_volume_name: str, source_volume_name: str, source_snapshot_name: str = None,
                 source_svm: str = None, target_svm: str = None,
...
def create_volume(volume_name: str, volume_size: str, guarantee_space: bool = False, svm_name: str = None,
...
def list_volumes(check_local_mounts: bool = False, include_space_usage_details: bool = False, print_output: bool = False, svm_name: str = None) -> list():
    # Retrieve config details from config file
    try:
        config = _retrieve_config(print_output=print_output)
    except InvalidConfigError:
