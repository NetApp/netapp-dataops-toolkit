...
The image extends the [Jupyter Docker Stacks](https://jupyter-docker-stacks.readthedocs.io/) `scipy-notebook` image, installs the toolkit, and registers a startup script that loads config from mounted Secrets.
